...
class uitlezenDataUtils
{
    public static function uitlezenDummyData($klant_id) {
        ...
        // php -r "require '/Applications/XAMPP/xamppfiles/htdocs/educom-ecopowrrr/symfony/src/utilities/uitlezenDataUtils.php'; echo json_encode(App\utilities\uitlezenDataUtils::uitlezenDummyData('7'));"
